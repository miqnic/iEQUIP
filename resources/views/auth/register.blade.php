            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="access_role" class="col-md-4 col-form-label text-md-right">{{ __('Access Role') }}</label>

                            <div class="col-md-6">
                                <input id="access_role" type="text" class="form-control" name="access_role" required>
                            </div>
                        </div>
