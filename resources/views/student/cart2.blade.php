    ...
    <div class="fill-up">
        ...
        <div class="form-group text-center">
            <div class="input-group mb-2">
                ...
                {{Form::textarea('reason', '',['class' => 'form-control', 'placeholder' => 'Enter the purpose of reservation', 'required' => ''])}} 
            </div>
        </div>
    </div>
</div>
...
<div class="wrapper text-center">
    <div class="btn-group text-center mt-2" role="group" aria-label="Basic example">
        <a href="cart1" class="btn btn-outline-secondary btn-lg">Previous</a>
