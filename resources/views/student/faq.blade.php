...
@section('head')
    ...
    .card {
        ...
        border-bottom: 3px solid #00007f !important;
    }

    .header {
        background-image: url('../img/faqheader.jpg');
        height: 400px;
        margin-top: -30px;
...
@section('content')
    <div class="mb-5 pb-5">
        ...
        <h1 class="text-center mb-3 pt-5 pb-5 text-uppercase" style="margin-top: -75px;">Frequently Asked Questions</h1>
        ...
        <div class="accordion w-75 pb-5 mx-auto" id="faq1">
            <hr>
            <div class="card">
                <div class="card-header" id="reservationq1" data-toggle="collapse" data-target="#reservationqcollapse1" aria-expanded="true" aria-controls="reservationqcollapse1">
                    <h2 class="mt-1">
            ...
            <div class="card">
                <div class="card-header" id="reservationq2" data-toggle="collapse" data-target="#reservationqcollapse2" aria-expanded="false" aria-controls="reservationqcollapse2">
                    <h2 class="mt-1">
            ...
            <div class="card">
                <div class="card-header" id="reservationq3" data-toggle="collapse" data-target="#reservationqcollapse3" aria-expanded="false" aria-controls="reservationqcollapse3">
                <h2 class="mt-1">
            ...
            <div class="card">
                <div class="card-header" id="reservationq4" data-toggle="collapse" data-target="#reservationqcollapse4" aria-expanded="false" aria-controls="reservationqcollapse4">
                <h2 class="mt-1">
            ...
            <div class="card">
                <div class="card-header" id="reservationq5" data-toggle="collapse" data-target="#reservationqcollapse5" aria-expanded="false" aria-controls="reservationqcollapse5">
                <h2 class="mt-1">
            ...
            <div class="card">
                <div class="card-header" id="reservationq6" data-toggle="collapse" data-target="#reservationqcollapse6" aria-expanded="false" aria-controls="reservationqcollapse6">
                <h2 class="mt-1">
            ...
            <div class="card">
                <div class="card-header" id="reservationq7" data-toggle="collapse" data-target="#reservationqcollapse7" aria-expanded="false" aria-controls="reservationqcollapse7">
                <h2 class="mt-1">
        ...
        <div class="accordion w-75 pb-5 mx-auto" id="faq2">
            <hr>
            <div class="card">
                <div class="card-header" id="penaltyq1" data-toggle="collapse" data-target="#penaltyqcollapse1" aria-expanded="true" aria-controls="penaltyqcollapse1">
                <h2 class="mt-1">
            ...
            <div class="card">
                <div class="card-header" id="penaltyq2" data-toggle="collapse" data-target="#penaltyqcollapse2" aria-expanded="false" aria-controls="penaltyqcollapse2">
                <h2 class="mt-1">
            ...
            <div class="card">
                <div class="card-header" id="penaltyq3" data-toggle="collapse" data-target="#penaltyqcollapse3" aria-expanded="false" aria-controls="penaltyqcollapse3">
                <h2 class="mt-1">
            ...
            <div class="card">
                <div class="card-header" id="penaltyq4" data-toggle="collapse" data-target="#penaltyqcollapse4" aria-expanded="false" aria-controls="penaltyqcollapse4">
                <h2 class="mt-1">
        ...
        <div class="accordion w-75 pb-5 mx-auto" id="faq3">
            <hr>
            <div class="card">
                <div class="card-header" id="accountq1" data-toggle="collapse" data-target="#accountqcollapse1" aria-expanded="true" aria-controls="accountqcollapse1">
                <h2 class="mt-1">
            ...
            <div class="card">
                <div class="card-header" id="accountq2" data-toggle="collapse" data-target="#accountqcollapse2" aria-expanded="true" aria-controls="accountqcollapse2">
                <h2 class="mt-1">
            ...
            <div class="card">
                <div class="card-header" id="accountq3" data-toggle="collapse" data-target="#accountqcollapse3" aria-expanded="true" aria-controls="accountqcollapse3">
                <h2 class="mt-1">
            ...
            <div class="card">
                <div class="card-header" id="accountq4" data-toggle="collapse" data-target="#accountqcollapse4" aria-expanded="true" aria-controls="accountqcollapse4">
                <h2 class="mt-1">
            ...
            <div class="card">
                <div class="card-header" id="accountq5" data-toggle="collapse" data-target="#accountqcollapse5" aria-expanded="true" aria-controls="accountqcollapse5">
                <h2 class="mt-1">
