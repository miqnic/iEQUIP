...
<div class="row py-4">
    <div class="col-md-3">
        ...
        <div class="count-container" style="background-image: linear-gradient(to bottom right, rgb(154,208,245), rgb(54, 162, 235))">
            ...
            <div class="dropdown-menu px-2 py-2" style="width: 550px; max-height: 400px; overflow: scroll;">
    ...
    <div class="col-md-3">
        <div class="count-container" style="background-image: linear-gradient(to bottom right, rgb(255,127,145), rgb(255, 0, 35))">
            ...
            <div class="dropdown-menu px-2 py-2" style="width: 420px; max-height: 400px; overflow: scroll;">
                <table class="table table-sm">
                    <thead class="bg-dark text-light text-center">
                        <th>Item Code</th>
                        <th>Item Name</th>
