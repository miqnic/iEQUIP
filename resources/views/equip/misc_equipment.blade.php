  ...
  <div class="row pb-3">
    <div cl ass="col-md-3">
      <div class="card text-center pt-2">
        <img src="images/chair.png" class="card-img-top align-self-center" alt="Item photo">
        <div class="card-body">
          <h5 class="card-title text-truncate">Swivel Chair</h5>
          <p class="card-text">Availability: 16/24</p>
